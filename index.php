    ...
    <main>
        ...
        <section id="products" class="products">
            <div class="product-card">
                <img src="View/img/manga-longa-preta.png"  alt="">
                <h3>Manga longa ZEN preta</h3>
                <p>R$80,00</p>
                <a href="View/Card manga longa/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/moletom-preto.png" alt="">
                <h3>Moletom ZEN preto</h3>
                <p>R$100,00</p>
                <a href="View/Card moletom/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/calça-preta.png" alt="">
                <h3>Calça ZEN preta</h3>
                <p>R$80,00</p>
                <a href="View/Card calça/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/camisa-preta.png" alt="">
                <h3>Camisa ZEN preta</h3>
                <p>R$60,00</p>
                <a href="View/Card camisa/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card"> 
                <img src="View/img/shorts-preto.png" alt="">
                <h3>Shorts ZEN preto</h3>
                <p>R$40,00</p>
               <a href="View/Card shorts/card.html"><button>Comprar</button></a>
            </div>
                               
                                    <!--linha 2-->

            <div class="product-card">
                <img src="View/img/manga-longa-bege.png" alt="">
                <h3>Manga longa ZEN branca</h3>
                <p>R$80,00</p>
                <a href="View/Card manga longa/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/moletom-bege.png" alt="">
                <h3>Moletom ZEN bege</h3>
                <p>R$100,00</p>
               <a href="View/Card moletom/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/calça-bege.png" height="280vh" width="300vh" alt="">
                <h3>Calça ZEN bege</h3>
                <p>R$80,00</p>
               <a href="View/Card calça/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/camisa-bege.png" alt="">
                <h3>Camisa ZEN bege</h3>
                <p>R$60,00</p>
                <a href="View/Card camisa/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/shorts-bege.png" alt="">
            ...
            <div class="product-card">
                <img src="View/img/manga-longa-roxa.png" alt="">
                <h3>Manga longa ZEN roxa</h3>
                <p>R$80,00</p>
                <a href="View/Card manga longa/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/moletom-vinho.png" alt="">
                <h3>Moletom ZEN roxo</h3>
                <p>R$100,00</p>
                <a href="View/Card moletom/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/calça-roxa.png" height="280vh" width="300vh" alt="">
                <h3>Calça ZEN roxa</h3>
                <p>R$80,00</p>
                <a href="View/Card calça/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/camisa-roxa.png" alt="">
                <h3>Camisa ZEN roxa</h3>
                <p>R$60,00</p>
                <a href="View/Card camisa/card.html"><button>Comprar</button></a>
            </div>
            <div class="product-card">
                <img src="View/img/shorts-roxo.png" alt="">
